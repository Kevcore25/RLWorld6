...
execute if entity @s[nbt={ActiveEffects:[{Id:32}]}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 1 0.5 0 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
# Ice
...
execute if entity @s[nbt={ActiveEffects:[{Id:2}]}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0 1 1 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
# Water
...
execute if entity @s[nbt={ActiveEffects:[{Id:27}]}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0 0 1 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
# Electric
...
execute if entity @s[nbt={ActiveEffects:[{Id:29}]}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 1 1 0 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
# Nature
...
execute if entity @s[nbt={ActiveEffects:[{Id:31}]}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0 0.5 0 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
...
execute if entity @s[scores={noAITime=1..}] run execute as @e[type=!block_display,tag=!important,distance=..5] if entity @s[type=!#arrows] if entity @s[type=!armor_stand] run particle minecraft:dust 0.5 1 0.5 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
execute if entity @s[scores={noAITime=1..}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0 2 2 2 ~ ~0.5 ~ 0.2 0.5 0.2 0 100
...
execute if entity @s[scores={burning=1..}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0.5 1 0.5 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
...
execute if entity @s[scores={superconduct=1..}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 0.5 1 0.5 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
execute if entity @s[scores={superconduct=1..}] run execute at @e[tag=!player,distance=..5] run particle minecraft:dust 1 0 1 1 ~ ~0.5 ~ 0.2 0.5 0.2 0 150
