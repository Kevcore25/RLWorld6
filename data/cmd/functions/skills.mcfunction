...
scoreboard players add @s firstaidLvlC 0
...
scoreboard players set @s[scores={firstaidLvlC=0}] firstaidLvlC 15
...
execute if score @s[scores={skills=6}] xp < @s firstaidLvlC run tellraw @s {"text":"Not enough skill points! Skill points are your in-game levels", "color":"red"}
execute if score @s[scores={skills=6}] xp >= @s firstaidLvlC run tag @s add CASL
execute if entity @s[scores={skills=6},tag=CASL] run scoreboard players add @s firstaidLvl 1
execute if entity @s[scores={skills=6},tag=CASL] run tellraw @s [{"text":"Upgraded First Aid Skill Level. (Now SL ","color":"green"},{"score":{"name":"@s","objective":"firstaidLvl"},"color":"green"},{"text":")","color":"green"}]
execute if entity @s[scores={skills=6},tag=CASL] run scoreboard players operation @s tempSkillCalc = @s firstaidLvlC
execute if entity @s[scores={skills=6},tag=CASL] run function cmd:calcskill
execute if entity @s[scores={skills=6},tag=CASL] run scoreboard players operation @s firstaidLvlC *= @e[type=armor_stand,tag=randomGen,scores={tempRandomgen=0}] skills
execute if entity @s[scores={skills=6},tag=CASL] run tag @s remove CASL





execute if entity @s[scores={skills=0..6}] run tellraw @s ["\n",{"text":"Skill Levels","color":"light_purple"},{"text":"\n\n"},{"text":"Combat: ","color":"aqua"},{"score":{"name":"@s","objective":"combatLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+)","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 1"}},{"text":" (","color":"aqua"},{"score":{"name":"@s","objective":"combatLvlC"},"color":"green"},{"text":" SP)\nAxes: ","color":"aqua"},{"score":{"name":"@s","objective":"axesLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+) ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 2"}},{"text":"(","color":"aqua"},{"score":{"name":"@s","objective":"axesLvlC"},"color":"green"},{"text":" SP)","color":"aqua"},{"text":"\n"},{"text":"Pickaxes: ","color":"aqua"},{"score":{"name":"@s","objective":"pickaxesLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+)","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 3"}},{"text":" (","color":"aqua"},{"score":{"name":"@s","objective":"pickaxesLvlC"},"color":"green"},{"text":" SP)","color":"aqua"},{"text":"\n"},{"text":"Gathering: ","color":"aqua"},{"score":{"name":"@s","objective":"gatheringLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+)","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 4"}},{"text":" (","color":"aqua"},{"score":{"name":"@s","objective":"gatheringLvlC"},"color":"green"},{"text":" SP)","color":"aqua"},{"text":"\nDefense: ","color":"aqua"},{"score":{"name":"@s","objective":"defenseLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+)","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 5"}},{"text":" (","color":"aqua"},{"score":{"name":"@s","objective":"defenseLvlC"},"color":"green"},{"text":" SP)","color":"aqua"},{"text":"\nFirst Aid: ","color":"aqua"},{"score":{"name":"@s","objective":"firstaidLvl"},"color":"green"},{"text":"/10 ","color":"dark_aqua"},{"text":"(+)","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger skills set 6"}},{"text":" (","color":"aqua"},{"score":{"name":"@s","objective":"firstaidLvlC"},"color":"green"},{"text":" SP)","color":"aqua"},{"text":"\n\n"},{"text":"Click the + to increase using Skill Points.\nDoubles each time you upgrade","color":"aqua"}]
...
execute if entity @s[scores={skills=10,xp=..39}] run tellraw @s {"text":"Not enough skill points! Skill points are your in-game levels", "color":"red"}
...
execute if entity @s[scores={skills=10,xp=40..}] run execute in the_end run tp @s 1000 100 1000
execute if entity @s[scores={skills=10,xp=40..}] run execute in the_end run setblock 1000 100 1000 end_portal
execute if entity @s[scores={skills=10,xp=40..}] run tellraw @s {"text":"Activated skill: Coming Home (ID 6)", "color":"green"}
execute if entity @s[scores={skills=10,xp=40..},nbt=!{Inventory:[{tag:{Volunteerer:1}}]}] run xp add @s -40 levels
execute if entity @s[scores={skills=10,xp=40..},nbt={Inventory:[{tag:{Volunteerer:1}}]}] run xp add @s -30 levels
