...
#remove pickup relic
clear @s leather_horse_armor{GetRelic:1}
# fix 2 relics
tag @s add SREClaimed
# summon it
summon item ~ ~ ~ {Tags:["notDone","nopickupdelay"],PickupDelay:0s,Item:{id:"minecraft:leather_horse_armor",Count:1b,tag:{Relic:1,RelicType:2,display:{Name:'[{"text":"Bronze Relic","italic":false,"color":"aqua"}]', Lore:['[{"text":"Relic Stats:","italic":false,"color":"light_purple"}]']}}}}
